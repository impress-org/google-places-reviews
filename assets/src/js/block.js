...
registerBlockType('google-places-reviews/reviews', {
    ...
    description: __(
        'Easily display Google Reviews on your WordPress website using a powerful and intuitive widget.',
    ...
    edit: ({attributes, setAttributes}) => {
        ...
        return (
            <Fragment>
                <InspectorControls>
                    <PanelBody title={__('Reviews Block for Google', 'google-places-reviews')} initialOpen={true}>
                        ...
                        <TextControl
                            ...
                            ref={locationRef}
                            help={__(
                                "Enter the name of your Google Place in this field to retrieve it's Google Place ID. If no information is returned there you may have a conflict with another plugin or theme using Google Maps API.",
                                'google-places-reviews'
                            )}
                        />
                        ...
                        <Fragment>
                            ...
                            <PanelBody title={__('Advanced Options', 'google-places-reviews')} initialOpen={false}>
                                ...
                                <p>
                                    ...
                                    {state.cacheError && <div className="gpr-alert gpr-error">{state.cacheError}</div>}
                                </p>
                ...
                {state.error ? (
                    <div className="gpr-alert gpr-error" dangerouslySetInnerHTML={{__html: state.error}} />
                ) : (
