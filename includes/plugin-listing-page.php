...
function gpr_add_plugin_page_links( $links, $file ) {
	...
	if ( $file == GPR_PLUGIN_NAME ) {
		...
		$settings_link = '<a href="' . admin_url( 'options-general.php?page=yelp_widget' ) . '">' . __( 'Settings', 'google-places-reviews' ) . '</a>';
...
function gpr_add_plugin_meta_links( $meta, $file ) {
	if ( $file == GPR_PLUGIN_NAME ) {
		$meta[] = "<a href='http://wordpress.org/support/view/plugin-reviews/google-places-reviews' target='_blank' rel='noopener noreferrer' title='" . __( 'Rate Yelp Widget Pro', 'google-places-reviews' ) . "'>" . __( 'Rate Plugin', 'google-places-reviews' ) . '</a>';
		$meta[] = "<a href='https://wpbusinessreviews.com/' target='_blank' rel='noopener noreferrer' title='" . __( 'Upgrade to Yelp Widget Premium', 'google-places-reviews' ) . "'>" . __( 'Upgrade to WP Business Reviews', 'google-places-reviews' ) . '</a>';
	}
